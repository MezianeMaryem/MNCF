...
public class meteo extends AppCompatActivity {
    ...
    public void FindWeather()
    {
        ...
        String url ="http://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=1f9069a471fd0af457dde1c48e7fc16f&units=metric";
        @SuppressLint("SetTextI18n") StringRequest stringRequest = new StringRequest(Request.Method.GET,url,
                ...
                }, error -> Toast.makeText(meteo.this,error.getLocalizedMessage(),Toast.LENGTH_SHORT).show());
